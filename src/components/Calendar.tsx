...
export const Calendar = () => {
    ...
    const handlePressArrowUpAndCtrl = () => {
        ...
        if (endOfHour) {
            ...
            if (endOfDay) {
                return setInputValue(
                    parseDate(`${updatedDay} ${month} ${year} ${DOUBLE_ZERO} ${DOUBLE_ZERO} ${seconds}`))
            }
        ...
        if (endOfYear) {
            return setInputValue(parseDate(`${ZERO_ONE} ${ZERO_ONE} ${updatedYear} ${hours} ${minutes} ${seconds}`))
        }
    }
    ...
    const handlePressArrowDownCtrlKey = () => {
        ...
        if (firstDay) {
            ...
            if (updatedNegativeMonth === DOUBLE_ZERO) {
                return setInputValue(
                    parseDate(`${THIRTY_ONE} ${TWELVE} ${updatedNegativeYear} ${hours} ${minutes} ${seconds}`))
            }
        ...
        if (zeroHour) {
            return setInputValue(
                parseDate(`${updatedNegativeDay} ${month} ${year} ${TWENTY_THREE} ${minutes} ${seconds}`))
        }
        ...
        if (zeroSeconds) {
            return setInputValue(parseDate(`${day} ${month} ${year} ${hours} ${minutes} ${FIFTY_NINE}`))
        }
    ...
    const handlePressArrowDown = () => {
        ...
        if (firstDayOfMonthWithThirtyDays) {
            return setInputValue(parseDate(`${THIRTY} ${month} ${year} ${hours} ${minutes} ${seconds}`))
        }
    }
